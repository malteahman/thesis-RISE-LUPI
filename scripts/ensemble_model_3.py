...
def ensamble_model(config, writer_priv, writer_LUPI, writer_RGB):
    ...
    for batch in tqdm(test_iter):
        ...
        priv_predictions = [y_pred_base_priv, y_pred_ts_priv, y_pred_transformer_priv]
        LUPI_predictions = [y_pred_ts_only_priv, y_pred_ts_LUPI, y_pred_transformer_LUPI] #10
...
def main(config):
    ...
    log_dir_priv =  '/raid/dlgroupmsc/logs/ensamble_model_test_priv_3/tensorboard'
    log_dir_LUPI =  '/raid/dlgroupmsc/logs/ensamble_model_test_LUPI_3/tensorboard'
    log_dir_RGB = '/raid/dlgroupmsc/logs/ensamble_model_test_RGB_3/tensorboard'
