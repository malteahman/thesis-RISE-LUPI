...
def ensamble_model(config, writer_priv, writer_LUPI, writer_RGB):
    ...
    unet_base_priv_model_path = os.path.join('/raid/dlgroupmsc/logs/best_100_w_priv', 'best_model.pth')
    unet_base_priv.load_state_dict(torch.load(unet_base_priv_model_path))

    unet_base_RGB = set_model(config, 'unet', n_channels=3)
    unet_base_RGB_model_path = os.path.join('/raid/dlgroupmsc/logs/2024-02-09_10-11-25', 'best_model.pth')
    unet_base_RGB.load_state_dict(torch.load(unet_base_RGB_model_path))

    unet_base_only_priv = set_model(config, 'unet', n_channels=2)
    unet_base_only_priv_model_path = os.path.join('/raid/dlgroupmsc/logs/2024-03-01_12-51-57', 'best_model.pth')
    ...
    zero_out_model_path = os.path.join('/raid/dlgroupmsc/logs/2024-02-26_12-03-45', 'best_model.pth')
    ...
    unet_pred_priv_path = os.path.join('/raid/dlgroupmsc/logs/2024-04-05_10-16-54','best_model.pth')
    unet_pred_priv.load_state_dict(torch.load(unet_pred_priv_path)) 

    unet_priv_mtd = set_model(config, 'unet_mtd', n_channels=5)
    unet_priv_mtd_path = os.path.join('/raid/dlgroupmsc/logs/2024-02-23_14-12-03','best_model.pth')
    unet_priv_mtd.load_state_dict(torch.load(unet_priv_mtd_path)) 

    unet_ts_priv = set_model(config, 'unet', n_channels=5)
    unet_ts_priv_model_path = os.path.join('/raid/dlgroupmsc/logs/2024-03-26_14-15-48', 'best_model.pth')
    ...
    unet_ts_RGB_model_path = os.path.join('/raid/dlgroupmsc/logs/2024-04-17_11-17-16', 'best_model.pth')
    ...
    unet_ts_LUPI_model_path = os.path.join('/raid/dlgroupmsc/logs/2024-03-14_16-07-11', 'best_model.pth')
    ...
    unet_ts_only_priv_model_path = os.path.join('/raid/dlgroupmsc/logs/2024-04-17_09-49-11', 'best_model.pth')
    ...
    unet_ts_LUPI_pred_model_path = os.path.join('/raid/dlgroupmsc/logs/2024-04-22_11-59-29', 'best_model.pth')
    ...
    unet_ts_LUPI_mtd_model_path = os.path.join('/raid/dlgroupmsc/logs/2024-04-23_16-21-21', 'best_model.pth')
    ...
    unet_ts_priv_mtd_model_path = os.path.join('/raid/dlgroupmsc/logs/2024-04-26_17-08-59', 'best_model.pth')
    ...
    transformer_ts_RGB_model_path = os.path.join('/raid/dlgroupmsc/logs/2024-04-26_15-15-04', 'best_model.pth')
    ...
    transformer_ts_LUPI_model_path = os.path.join('/raid/dlgroupmsc/logs/2024-04-26_15-20-25', 'best_model.pth')
    ...
    transformer_ts_priv_model_path = os.path.join('/raid/dlgroupmsc/logs/2024-05-02_10-40-10', 'best_model.pth')
...
def main(config):
    ...
    log_dir_priv =  '/raid/dlgroupmsc/logs/ensamble_model_test_priv_100/tensorboard'
    log_dir_LUPI =  '/raid/dlgroupmsc/logs/ensamble_model_test_LUPI_100/tensorboard'
    log_dir_RGB = '/raid/dlgroupmsc/logs/ensamble_model_test_RGB_100/tensorboard'
